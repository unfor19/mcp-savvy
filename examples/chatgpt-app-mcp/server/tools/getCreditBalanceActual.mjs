 ...
 * the real balance.
 *
 * Visibility is `["app"]`; the model never sees this tool listed,
 * never invokes it, and never receives its result. The widget calls
...
export const TOOL_DEFINITION = Object.freeze({
    ...
    description:
        ...
        'credit balance in the tool result `_meta` (hidden from the model). The widget ' +
    ...
    _meta: {
        ...
        // The model never sees this tool listed and cannot invoke it.
        ui: { visibility: ['app'] },
