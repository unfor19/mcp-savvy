...
/** Inputs for the kb-mcp Cognito stack. */
...
/**
 * Cognito user pool for the kb-mcp demo. Thin wrapper around
 * `@mcp-savvy/cdk`'s `CognitoAuth` so the example shows users
 * how to compose the construct inside their own CDK app.
 */
export class CognitoStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props: CognitoStackProps) {
        ...
        this.auth = new CognitoAuth(this, 'Auth', {
            ...authProps,
            userPoolName: 'mcp-savvy-kb-demo',
        });
